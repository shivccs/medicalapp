    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>medical_entry/register">
   ...
   <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                  <select class="form-control" name="manufacture" required>
                    ...
                    <option value="<?php echo $catvalue['manufacturer_id']; ?>"><?php echo $catvalue['manufacturer_name']; ?></option>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                  <select class="form-control" name="unit" required>
                    ...
                    <option value="<?php echo $catvalue['unit_id']; ?>"><?php echo $catvalue['unit_name']; ?></option>
               ...
               <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                  <select class="form-control" name="leaf" required>
                    ...
                    <option value="<?php echo $catvalue['leaf_id']; ?>"><?php echo $catvalue['leaf_name']; ?></option>
			  ...
			  <br />
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
               <input type="text" class="form-control" onkeypress="allowNumbersOnly(event)" name="price" required>
                </div> 
				 <div class="col-md-2 col-sm-3 col-xs-12">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                <input type="text" class="form-control" name="quantity"  onkeypress="allowNumbersOnly(event)" required>
                </div> 
<script>
