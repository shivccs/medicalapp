...
class symptoms_delete extends MX_Controller {
	...
	{	
		...
		$result = $this->pharmacy_units_model->delete_data('symptoms_id',$id,'symptoms');
		 //$result = $this->pharmacy_units_model->edit_data('medical_item_id',$id,$data,'medical_item');
		 $this->session->set_flashdata('msg', 'deleted successfully');
		 redirect(base_url().'template/symptoms_list');
