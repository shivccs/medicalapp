  ...
  <div class="panel panel-info" style="margin: 1em;">
              ...
              <div class="row">
			   ...
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                       <i class="fa fa-male"></i>  <?php if($doc_data['gender']=='m') { echo "Male";} if($doc_data['gender']=='f') { echo "FeMale";} if($doc_data['gender']=='o') { echo "Other";}   ?>
                    </div>
                </div>
				</div>
				  <div class="col-md-4 col-sm-4 col-xs-12">
			   ...
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                <i class="fa fa-birthday-cake"></i>    <?php echo $doc_data['dob']; ?>
				  </div>
                </div>
				</div>
				 <div class="col-md-4 col-sm-4 col-xs-12">
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                   <i class="fa fa-list"></i>  <?php echo $doc_data['category_name']; ?>
				  </div>
                </div>
				</div>
				 <div class="col-md-4 col-sm-4 col-xs-12">
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                  <i class="fa fa-home"></i>   <?php echo $doc_data['address']; ?>
				  </div>
                </div>
				</div>
				 <div class="col-md-4 col-sm-4 col-xs-12">
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                 <i class="fa fa-institution"></i> <?php echo $doc_data['state_name']; ?>
				  </div>
                </div>
				</div>
				 <div class="col-md-4 col-sm-4 col-xs-12">
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                   <i class="fa fa-institution"></i>  <?php echo $doc_data['city_name']; ?>
				  </div>
                </div>
				</div>
				 <div class="col-md-4 col-sm-4 col-xs-12">
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                   <i class="fa fa-map-pin"></i><?php echo $doc_data['pincode']; ?>
				  </div>
                </div>
				</div>
				 <div class="col-md-4 col-sm-4 col-xs-12">
			   ...
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                 <i class="fa fa-map-marker"></i>  <?php echo $doc_data['longitude']; ?>
				  </div>
                </div>
				</div>
               </div>
              ...
              <div class="row">
			   ...
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                 <i class="fa fa-university"></i>   <?php echo $doc_data['council']; ?>
				  </div>
                </div>
				</div>
				 <div class="col-md-4 col-sm-4 col-xs-12">
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                 <i class="fa fa-calendar"></i>   <?php echo $doc_data['passout']; ?>
				  </div>
                </div>
				</div>
				 <div class="col-md-4 col-sm-4 col-xs-12">
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                  <i class="fa fa-certificate"></i> <?php echo $doc_data['degree']; ?>
				  </div>
                </div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12">
			  ...
			  <div class="col-md-4 col-sm-4 col-xs-12">
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                 <i class="fa fa-building"></i> <?php echo $doc_data['collage']; ?>
				  </div>
                </div>
				</div>
			  ...
			  <div class="col-md-4 col-sm-4 col-xs-12">
			   <div class="panel panel-info" style="margin: 1em;">
                    ...
                    <div class="panel-body">
                  <i class="fa fa-user-md"></i> <?php echo $doc_data['exp']; ?>
				  </div>
                </div>
				</div>
