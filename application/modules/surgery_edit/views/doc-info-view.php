  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Surgery Edit <small></small></h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <br />
			
            <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>surgery_edit/edit">
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                  <input type="text" required="required" value="<?php echo $row->surgery_name; ?>" name="allergy" id="name" class="form-control" required>
				   <input type="hidden" required="required" value="<?php echo $row->surgery_id; ?>" name="aid" id="name" class="form-control" required>
                </div>
