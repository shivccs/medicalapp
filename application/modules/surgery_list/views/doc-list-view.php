            ...
            <div class="col-md-12">
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $sno; ?></td>
                      <td><?php echo $udvalue['surgery_id']; ?></td>
                      <td><?php echo $udvalue['surgery_name']; ?></td>
					  ...
					  <td>
                        ...
                        <td>
                          <a href="<?php echo base_url(); ?>template/surgery_delete/<?php echo $udvalue['surgery_id']; ?>" class="text-danger">
