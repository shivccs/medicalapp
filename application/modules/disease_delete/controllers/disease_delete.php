...
class disease_delete extends MX_Controller {
	...
	{	
		...
		$result = $this->pharmacy_units_model->delete_data('cronic_disease_id',$id,'cronic_disease');
		//$result = $this->pharmacy_units_model->edit_data('cronic_disease_id',$id,$data,'cronic_disease');
		 $this->session->set_flashdata('msg', 'deleted successfully');
		 redirect(base_url().'template/disease_list');
